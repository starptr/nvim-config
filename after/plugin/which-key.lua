...
local which_key_tables = {
  ...
  f = {
    ...
    f = { function()
      -- If inside a git repo, use git_files instead of find_files
  ...
  g = {
    ...
    c = { name = "+conflict",
      ...
      d = {'<cmd>GitConflictChooseNone<cr>', 'Choose None' },
      ['['] = {'<cmd>GitConflictPrevConflict<cr>', 'Go to previous' },
      [']'] = {'<cmd>GitConflictNextConflict<cr>', 'Go to next' },
      q = {'<cmd>GitConflictListQf<cr>', 'Copy to qf' },
    },
